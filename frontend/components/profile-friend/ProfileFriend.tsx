    ...
    return (
        <Link className='rightbar-user-friends-followings-following-link' to={'/profile/' + userProfile?.profileDisplayId}>
            <div className='rightbar-user-friends-followings-following'>
                <img className='rightbar-user-friends-followings-following-image' src={userProfile?.coverPicturePath ? assetsFolder + userProfile?.coverPicturePath : 'images/no-cover-picture.png'} alt='user-following' />
